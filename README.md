...
随着计算机技术的发展以及计算机网络的逐渐普及，互联网成为人们查找信息的重要场所，二十一世纪是信息的时代，所以信息的管理显得特别重要。因此，使用计算机来管理基于java web的中小型人力资源管理系统的相关信息成为必然。开发合适的基于java web的中小型人力资源管理系统，可以方便管理人员对基于java web的中小型人力资源管理系统的管理，提高信息管理工作效率及查询效率，有利于更好的为人们服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。基于java web的中小型人力资源管理系统的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

对于之前基于java web的中小型人力资源管理系统的管理，大部分都是使用传统的人工方式去管理，这样导致了管理效率低下、出错频率高。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个基于java web的中小型人力资源管理系统刻不容缓，能够提高信息的管理水平。
## 1.3系统设计思想
...
# 3系统分析
## 3.1可行性分析
通过对本基于java web的中小型人力资源管理系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本基于java web的中小型人力资源管理系统采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
因此，基于java web的中小型人力资源管理系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本基于java web的中小型人力资源管理系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本基于java web的中小型人力资源管理系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此基于java web的中小型人力资源管理系统要严格控制管理权限，具体要求如下：

（1）要想对基于java web的中小型人力资源管理系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
本系统是基于B/S架构的网站系统，设计的人事管理员功能结构图如下图所示：
...
图4.14 管理员信息实体属性图
### 4.3.2数据库设计表
基于java web的中小型人力资源管理系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|diaoxiubianhao|varchar(200)|是|NULL|调休编号|
|riqi|date|是|NULL|日期|
|gonghao|varchar(200)|是|NULL|工号|
|xingming|varchar(200)|是|NULL|姓名|
|shouji|varchar(200)|是|NULL|手机|
|diaoxiuyuanyou|longtext|是|NULL|调休缘由|
...
|ruzhishijian|varchar(200)|是|NULL|入职时间|
|yuanzhixinzi|int(11)|是|NULL|原职薪资|
|diaorubumen|varchar(200)|是|NULL|调入部门|
|diaorugangwei|varchar(200)|是|NULL|调入岗位|
|diaodongshuoming|longtext|是|NULL|调动说明|
|shenqingriqi|date|是|NULL|申请日期|
|gangweixinchou|int(11)|是|NULL|岗位薪酬|
|shengxiaoriqi|date|是|NULL|生效日期|
表4.3 工资单
...
|gonghao|varchar(200)|是|NULL|工号|
|xingming|varchar(200)|是|NULL|姓名|
|gudingyuexin|int(11)|是|NULL|固定月薪|
|jixiaojiangjin|int(11)|是|NULL|绩效奖金|
|suodeshui|int(11)|是|NULL|所得税|
|shebao|int(11)|是|NULL|社保|
|gongjijin|int(11)|是|NULL|公积金|
|yingfagongzi|int(11)|是|NULL|应发工资|
...
|dakaleixing|varchar(200)|是|NULL|打卡类型|
...
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|shijian|date|是|NULL|时间|
|zhouqi|varchar(200)|是|NULL|周期|
|jiangshi|varchar(200)|是|NULL|讲师|
|kecheng|varchar(200)|是|NULL|课程|
|jiaoxuefankui|longtext|是|NULL|教学反馈|
表4.11 员工信息
...
|bumen|varchar(200)|是|NULL|部门|
|zhiwei|varchar(200)|是|NULL|职位|
|shangji|varchar(200)|是|NULL|上级|
|bangongdidian|varchar(200)|是|NULL|办公地点|
|ruzhishijian|datetime|是|NULL|入职时间|
...
## 5.1 管理员模块的实现
### 5.1.1 人事管理员管理
基于java web的中小型人力资源管理系统的系统管理员可以管理项目中检，可以对项目中检信息添加修改删除以及查询操作。具体界面的展示如图5.1所示。

![](/md/blog.012.png)

图5.1 人事管理员管理界面
### 5.1.2 普通员工管理
系统管理员可以对普通员工信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。
...
## 5.2 人事管理员模块的实现
### 5.2.1 普通员工管理
人事管理员可以对普通员工信息进行修改，删除以及查询操作。界面如下图所示：

![](/md/blog.014.png)

图5.3 普通员工信息管理界面
### 5.2.1 调休申请管理
人事管理员可以对项目结项信息进行修改操作，还可以对项目结项信息进行查询。界面如下图所示：
...
## 5.2 员工模块的实现
### 5.2.2 入职信息管理
员工登录后可以填写自己的入职信息。界面如下图所示：

![](/md/blog.016.png)

图5.5 入职信息界面
### 5.2.3 岗位调动信息
员工登录后可以查看岗位调动。界面如下图所示：
